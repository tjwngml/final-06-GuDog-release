    ...
    <>
      ...
      <div className="mb-6">
        <div className="flex items-center mb-4">
          <div>
            <h1 className="text-3xl font-semibold text-gray-900">상품 Q&amp;A</h1>
            <p className="mt-1 text-sm text-gray-600">상품에 대한 문의 사항을 관리하세요</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-semibold text-gray-900">{productInfo.name}</h2>
